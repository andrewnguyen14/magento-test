...
class Save extends View
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $subscription->setInstructions($data['instructions']);
            $subscription->setShippingInstructions($data['shipping_instructions']);
            $subscription->setProductCode($data['product_code']);
            $subscription->setDaysPerWeek($data['days_per_week']);
            $subscription->setSubscriptionGroup($data['subscription_group']);
