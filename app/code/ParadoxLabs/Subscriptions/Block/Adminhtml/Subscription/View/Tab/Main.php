...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Subscription Group ID'),
                'title' => __('Subscription Group ID'),
            ]
        );
    ...
    public function log($string='',$array=[])
    {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/le.log');
