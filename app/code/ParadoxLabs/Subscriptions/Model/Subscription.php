...
class Subscription extends \Magento\Framework\Model\AbstractExtensibleModel implements SubscriptionInterface
{
    ...
    {
        return $this->getData('shipping_instructions');
    }
    ...
    {
        $this->setData('shipping_instructions', $shippingInstructions);
    ...
    {
        $this->setData('instructions', $instructions);
    ...
    {
        $this->setData('product_code', $productCode);
    ...
    {
        return $this->getData('subscription_group');
    }
    ...
    {
        $this->setData('subscription_group', $subscriptionGroup);
    ...
    {
        return $this->getData('days_per_week');
    }
    ...
    {
        $this->setData('days_per_week', $daysPerWeek);
