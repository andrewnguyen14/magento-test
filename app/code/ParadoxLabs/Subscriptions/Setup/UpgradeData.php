...
class UpgradeData implements \Magento\Framework\Setup\UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        /**
         * On upgrade to 3.1.4.20191223, reset keyword_fulltext to subscriptions
         */
        if (version_compare($context->getVersion(), '3.1.4.20191223', '<')) {
            $this->resetKeywordFulltextToSubscriptions($setup);
        }
    }
    ...
    /**
     * Update query for reset keyword_fulltext to subscriptions
     *
     * @return void
     */
    protected function resetKeywordFulltextToSubscriptions(
        ModuleDataSetupInterface $setup
    ) {
        $quoteDb = $setup->getConnection('checkout');
         ...
         * Query based on ParadoxLabs\Subscriptions\Setup\UpgradeSchema:addKeywordFulltextToSubscriptions
         */
