<?php
namespace FNL\FedexImport\Model\Import;
  
use FNL\FedexImport\Model\Import\FedexImport\RowValidatorInterface as ValidatorInterface;
use Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregatorInterface;
  
class FedexImport extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    const ID = 'fedex_id';
    const QUESTION = 'question';
    const DATE = 'created_at';
    const TABLE_ENTITY = 'fedex';
